...
var certificatesResource = schema.GroupVersionResource{Group: "certs.k8s.io", Version: "v1alpha1", Resource: "certificates"}

var certificatesKind = schema.GroupVersionKind{Group: "certs.k8s.io", Version: "v1alpha1", Kind: "Certificate"}
