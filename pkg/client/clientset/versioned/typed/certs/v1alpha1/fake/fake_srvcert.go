...
// FakeSrvCerts implements SrvCertInterface
type FakeSrvCerts struct {
...
func (c *FakeSrvCerts) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(srvcertsResource, c.ns, opts))
