...
type CertsV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*CertsV1alpha1Client, error) {
	...
	return &CertsV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CertsV1alpha1Client for the given config and
